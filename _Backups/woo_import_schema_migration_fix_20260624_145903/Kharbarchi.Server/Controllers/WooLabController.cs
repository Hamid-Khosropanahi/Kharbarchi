...
LIMIT @take;";
    ...
    : externalId.Trim();
        ...
        command.Parameters.AddWithValue("@ExternalId", safeExternalId);
        command.CommandText = @"
INSERT INTO khb_imported_woocommerce_records
(SourceType, SourceUrl, ExternalId, Name, Status, RawJson, CreatedAtUtc)
VALUES (@SourceType, @SourceUrl, @ExternalId, @Name, @Status, @RawJson, UTC_TIMESTAMP());";
